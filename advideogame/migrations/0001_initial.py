# -*- coding: utf-8 -*-
# Generated by Django 1.9 on 2016-05-19 17:21
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tag_file', models.FileField(null=True, upload_to=advideogame.models.Occurrence.never_user_upload)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('special_case_release', models.CharField(blank=True, choices=[('L', 'loose'), ('C', 'naked composition')], help_text="'loose' if the absence of the object's packaging makes it impossible to indentify the exact release.<br/>'naked composition' for releases that are exclusively used for composing others, without a discrete packaging. (eg. Controller within a console.)", max_length=1)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('variant_name', models.CharField(blank=True, max_length=32, unique=True)),
        ...
        migrations.AddField(
            model_name='purchase',
            name='pickup_person',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='supervisor.Person'),
        ),
        migrations.AlterUniqueTogether(
            name='occurrencecomposition',
